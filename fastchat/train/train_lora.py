...
def train():
    ...
    #     model.base_model.model.model.layers[layer_i].self_attn.q_proj.lora_B.half().to(device)
    #     model.base_model.model.model.layers[layer_i].self_attn.q_proj.lora_A.half().to(device)

    #     device = model.base_model.model.model.layers[layer_i].self_attn.v_proj.weight.device
    #     model.base_model.model.model.layers[layer_i].self_attn.v_proj.lora_B.half().to(device)
    #     model.base_model.model.model.layers[layer_i].self_attn.v_proj.lora_A.half().to(device)
