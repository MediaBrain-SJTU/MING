...
class MoLoRAQwenForCausalLM(Qwen2ForCausalLM):
    ...
    def forward(
        ...
        #     #                 # param_ = safe_get_full_fp32_param(param_)
        #     #                 with deepspeed.zero.GatheredParameters(param):
        #     #                     with deepspeed.zero.GatheredParameters(param_):
                                    
        #     #                         # print(param, param_)
                            
        #     #                         orthogonal_loss += torch.abs(input=torch.mm(param, param_.transpose(0, 1))).sum() # [r * dim] * [dim * r]
        #     loss = loss + orthogonal_loss * 0.5 
