...
CKPT=qwen1.5-1.8b-molora-r16a32_share_expert_2_orthlora_3epoch_0001
...
sbatch -o ${LOGS_BASE_PATH}/${CKPT}/train.log scripts/train/srun/sft_molora_r16a32_share_orthlora.sh $TASK_PATH $TRAINING_DATA $MODEL_BASE $SAVE_PATH $LOGS_BASE_PATH $CKPT $LORA_PATH & sleep 1